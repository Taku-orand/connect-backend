...
Question.create(title:"test1", content:"test_content1", like:0, user_id:1, status: false, anonymous:true)
Question.create(title:"test2", content:"test_content2", like:100, user_id:1, status: true, anonymous:false)
Question.create(title:"test3", content:"test_content3", like:0, user_id:2, status: false, anonymous:true)
Question.create(title:"test4", content:"test_content4", like:20, user_id:3, status: true, anonymous:false)
Question.create(title:"test5", content:"test_content5", like:0, user_id:4, status: false, anonymous:true)
